...
// ponytail: bouncy spring for all buttons
const bounceTransition = { type: "spring" as const, stiffness: 500, damping: 20 }
...
function Button({
  ...
  return (
    <motion.div whileTap={{ scale: 0.95 }} transition={bounceTransition} className="inline-flex">
      <ButtonPrimitive
        data-slot="button"
