...
const PersonaWithModel = memo(
  ({ rive, source, children, forceColor }: PersonaWithModelProps) => {
    ...
    useEffect(() => {
      ...
      const [r, g, b] = forceColor ?? (theme === "dark" ? [255, 255, 255] : [0, 0, 0]);
      viewModelInstanceColor.setRgb(r, g, b);
    }, [viewModelInstanceColor, theme, source.dynamicColor, forceColor]);
...
export const Persona: FC<PersonaProps> = memo(
  ({
    ...
    return (
      <Component rive={rive} source={source} forceColor={forceColor}>
